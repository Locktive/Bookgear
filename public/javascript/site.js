...
function visibilyBlocosPedido() {
    ...
    switch (andares) {
        ...
        case "1":
            ...
            document.getElementById("infoGerarPedido").style.paddingTop = "450px";

            //Descrição das cores e padrões
            document.getElementById("andar1GerarPedido").style.display = 'block'
            document.getElementById("andar1Lamina1").innerHTML = getCookie("NomeCorBloco1Lamina1");
            document.getElementById("andar1Lamina2").innerHTML = getCookie("NomeCorBloco1Lamina2");
            document.getElementById("andar1Lamina3").innerHTML = getCookie("NomeCorBloco1Lamina3");
            document.getElementById("andar1Padrao1").innerHTML = getCookie("NomeBloco1Padrao1");
            if (getCookie("NomeBloco1Padrao2") == 'Texto') {
                document.getElementById("andar1Padrao2").innerHTML = getCookie("NomeBloco1Padrao2") + " (" + (getCookie("Bloco1Texto2") == '' ? '-----' : getCookie("Bloco1Texto2").toUpperCase()) + ")";
            } else {
                document.getElementById("andar1Padrao2").innerHTML = getCookie("NomeBloco1Padrao2")
            }
            document.getElementById("andar1Padrao3").innerHTML = getCookie("NomeBloco1Padrao3");

            document.getElementById("andar2GerarPedido").style.display = 'none'

            document.getElementById("andar3GerarPedido").style.display = 'none'
        ...
        case "2":
            ...
            document.getElementById("infoGerarPedido").style.paddingTop = "550px";
            ...
            document.getElementById("andar2GerarPedido").style.display = 'block'
            document.getElementById("andar2Lamina1").innerHTML = getCookie("NomeCorBloco2Lamina1");
            document.getElementById("andar2Lamina2").innerHTML = getCookie("NomeCorBloco2Lamina2");
            document.getElementById("andar2Lamina3").innerHTML = getCookie("NomeCorBloco2Lamina3");
            document.getElementById("andar2Padrao1").innerHTML = getCookie("NomeBloco2Padrao1");
            document.getElementById("andar2Padrao2").innerHTML = getCookie("NomeBloco2Padrao2");
            document.getElementById("andar2Padrao3").innerHTML = getCookie("NomeBloco2Padrao3");
        ...
        case "3":
            ...
            document.getElementById("infoGerarPedido").style.paddingTop = "670px";
            ...
            document.getElementById("andar3GerarPedido").style.display = 'block'
            document.getElementById("andar3Lamina1").innerHTML = getCookie("NomeCorBloco3Lamina1");
            document.getElementById("andar3Lamina2").innerHTML = getCookie("NomeCorBloco3Lamina2");
            document.getElementById("andar3Lamina3").innerHTML = getCookie("NomeCorBloco3Lamina3");
            document.getElementById("andar3Padrao1").innerHTML = getCookie("NomeBloco3Padrao1");
            document.getElementById("andar3Padrao2").innerHTML = getCookie("NomeBloco3Padrao2");
            document.getElementById("andar3Padrao3").innerHTML = getCookie("NomeBloco3Padrao3");
